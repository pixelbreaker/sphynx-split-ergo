...
tasks.add(
  tf(base_output, "stl"),
  (out, input) =>
    spawnPromise("openscad", ["-o", out, input]).then((stl_result) => {
...
//         "..",
//         "slic3r_config",
//         "cube_normal_duramic_black.ini"
//       ),
//     ];
//     const { slicer } = JSON.parse(
...
//     );
//   },
//   tf(base_output, "settings.json"),
//   tf(base_output, "stl")
// );

// tasks.add(
//   tf(base_output, "upload"),
//   (out, gcode) =>
//     spawnPromise("curl", [
//       "-k",
//       "-H",
